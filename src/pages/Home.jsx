        ...
        <div className="hero-content-wrapper">
          <motion.div className="hero-text" initial="hidden" animate="visible" variants={staggerContainer} style={{ y: heroY, opacity: heroOpacity }}>
            ...
            <motion.div variants={fadeUp} className="hero-buttons" style={{ flexWrap: 'wrap' }}>
              ...
              <Magnetic>
                <a href="public/ALBERT_LIVINGSTANG_Resume.pdf" download="ALBERT_LIVINGSTANG_Resume.pdf" className="btn btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }}>
